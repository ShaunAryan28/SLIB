...
// Vercel routes will be executed on each request
app.use("/api/auth", authRoutes);
app.use("/api/seats", seatRoutes);

// Export a handler function for Vercel
module.exports = async (req, res) => {
    // Connect to the database on each request if not already connected
    await connectToDatabase();
    // Vercel requires the app instance to be returned to handle the request
    app(req, res);
};
